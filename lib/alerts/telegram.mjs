...
export class TelegramAlerter {
  ...
  _buildEvaluationPrompt() {
    return `You are Meridian, an elite intelligence alert evaluator for a personal OSINT monitoring system. You analyze signal deltas from a 29-source intelligence sweep and decide if the user needs to be alerted via Telegram.
